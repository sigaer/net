<div id="head" style="position: fixed;z-index: 1;">
    ...
    <div class="lis">
        ...
        <ul>
            <li><span class="sprite miku"></span><a href="intro.html#id=1">miku</a></li>
            <li><span class="sprite rin"></span><a href="intro.html#id=2">rin</a></li>
            <li><span class="sprite len"></span><a href="intro.html#id=3">len</a></li>
            <li><span class="sprite luka"></span><a href="intro.html#id=4">luka</a></li>
            <li><span class="sprite kaito"></span><a href="intro.html#id=5">kaito</a></li>
            <li><span class="sprite meiko"></span><a href="intro.html#id=6">meiko</a></li>
        </ul>
    </div>
    <div class=right>
        <div class=xtitle>
        ...
        <ul>
            <li>
                <a href="show.html#id=1">什么是vocaloid?</a>
            </li>
            <li>
                <a href="show.html#id=2">vocaloid的发展历程</a>
            </li>
            <li>
            ...
            <li>
                <a href="show.html#id=5">vocaloid参数介绍</a>
            </li>
        </ul>
    </div>
    <div class=center>
